...
export function AccessDenied() {
  ...
  const description =
    t("صلاحيات دورك لا تشمل هذا القسم. تواصل مع مسؤول مؤسستك أو اطلب صلاحية الوصول عبر صفحة المساعدة.", "Your role doesn't include permission for this section. Contact your organization's administrator, or request access through Help.");
  const requestLabel = t("طلب صلاحية وصول", "Request access");
  const backLabel = t("العودة إلى لوحة التحكم", "Back to dashboard");
